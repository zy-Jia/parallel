...
void OpenMP_MPI(int argc, char *argv[]) {// using OpenMP and MPI method
    ...
    #pragma omp parallel for reduction(+:pi_per_rank)
    ...
    if(rank == 0) {
        ...
        printf("CPU using OpenMP and MPI method time used %lf ms\n", time_used * 1000);\
